            ...
            <div className="flex items-center space-x-2">
              ...
              <button
                ...
                className={cn(
                  ...
                  isStealthMode && 'bg-orange-100 text-orange-700 dark:bg-orange-900/30 dark:text-orange-300'
                )}
...
export const Breadcrumb = () => {
  ...
  const getBreadcrumbItems = () => {
    ...
    if (path === '/subscription') {
      items.push({ label: isStealthMode ? 'Settings' : '我的订阅', path: '/subscription' })
    } else if (path === '/history') {
      items.push({ label: isStealthMode ? 'Reports' : '历史榜单', path: '/history' })
    }
