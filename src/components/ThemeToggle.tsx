  ...
  return (
    <div className={cn("relative", className)}>
      ...
      <button
        ...
        className="inline-flex items-center justify-center w-9 h-9 rounded-lg transition-all duration-300 cosmic-glow"
        style={{
        ...
        onMouseEnter={(e) => {
          ...
          e.currentTarget.style.borderColor = "var(--light-purple)";
        }}
        onMouseLeave={(e) => {
      ...
      {showLabel && (
        <span className="ml-2 text-sm cosmic-text-secondary">
          {currentTheme.label}
        </span>
      )}
    </div>
